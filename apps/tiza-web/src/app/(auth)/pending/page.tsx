...
import { Button, Spinner, ErrorMessage } from '@tiza/ui';
...
export default function PendingPage() {
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="flex flex-col gap-3">
          <Button brand="tiza" variant="outline" className="w-full" onClick={handleRetry}>
            Reintentar
          </Button>
          <Link
            href="/login"
  ...
  return (
    <div className="space-y-8">
      {/* Header */}
      <div className="text-center">
        <div className="mx-auto h-14 w-14 flex items-center justify-center rounded-full bg-brand-light">
      ...
      <Link
        href="/login"
        className="block w-full text-center px-4 py-2 text-base font-medium rounded-lg border-2 border-brand-primary text-brand-primary hover:bg-brand-light transition-colors duration-200"
      >
        Volver al inicio
      </Link>
    </div>
